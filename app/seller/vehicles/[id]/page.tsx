							...
							<div className="grid grid-cols-2 gap-4">
								...
								{vehicle.city && (
									<div className="flex items-center gap-2">
										...
										<span className="text-sm">Location: {vehicle.city}</span>
									</div>
								)}
							</div>
							...
							{vehicle.vinNumber && (
								<>
									...
									<div>
										...
										<span className="text-sm ml-2">{vehicle.vinNumber}</span>
									</div>
								</>
							)}
						...
						<CardContent>
							<div className="grid grid-cols-2 md:grid-cols-3 gap-2">
								{[
									...
									.filter((feature) => vehicle[feature.key as keyof Vehicle])
									.map((feature) => (
										<Badge
											key={feature.key}
											variant="outline"
